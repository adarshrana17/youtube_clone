...
const MyChannel = () => {
  ...
  return (
    <>
      ...
      <div
        className={`${sidebar ? "w-[calc(100%-230px)] ml-auto" : "w-screen"}`}
      >
          ...
          {loading ? (
            ...
            <div className="container w-full max-w-4xl flex flex-col gap-10 px-5">
              ...
              <div className="upper flex flex-col items-start sm:flex-row items-center sm:items-start gap-5 sm:gap-10">
                <div className="channelBanner">
                  {channel.channelImage ? (
                    ...
                    <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-52 md:h-52 flex justify-center items-center rounded-full bg-gray-400 text-6xl text-white">
                ...
                <div className="channel-details flex flex-col gap-2.5 mt-2.5 text-center text-left">
                  ...
                  <div className="flex flex-col md:flex-row gap-3 w-fit md:gap-5">
                    <button className="px-3 py-2 bg-gray-200 rounded-4xl md:px-3 md:py-2">
                      Customize Channel
                    </button>
                    <button className="px-3 py-2 bg-gray-200 rounded-4xl md:px-3 md:py-2">
                      Manage Videos
              ...
              <div className="w-screen">
                <h1 className="md:text-center text-center text-lg font-semibold">
                  All Videos
                </h1>
              </div>
            </div>
