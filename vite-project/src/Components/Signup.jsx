    ...
    <>
      ...
      <div className="flex min-h-screen justify-center items-center bg-gray-100 p-4 mt-15">
        <form
          ...
          className="flex flex-col rounded shadow-2xl bg-white justify-center items-center p-5 gap-5 w-full max-w-3xl"
        >
          <p className="text-center text-3xl font-bold text-blue-600 m-3">
            Registration Form
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-10 w-full">
            <div className="left flex flex-col gap-3 w-full md:w-1/2">
              <label htmlFor="name" className="label-text">
                Full Name <span className="text-red-600 text-[15px]">*</span>
              </label>
              <input
                type="text"
                name="fullName"
              ...
              <label htmlFor="email" className="label-text">
                Email <span className="text-red-600 text-[15px]">*</span>
              </label>
              <input
                type="email"
                name="email"
              ...
              <label htmlFor="password" className="label-text">
                Password <span className="text-red-600 text-[15px]">*</span>
              </label>
              <input
                type="password"
                name="password"
            ...
            <div className="right flex flex-col gap-3 w-full md:w-1/2">
              ...
              <label htmlFor="mobile" className="label-text">
                Phone Number <span className="text-red-600 text-[15px]">*</span>
              </label>
              <input
                type="text"
                name="mobile"
              ...
              <label htmlFor="profileImage" className="label-text">
                Profile Image
              </label>
              <input
                type="file"
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 text-white py-2 text-xl rounded w-full"
          >
            Register
          </button>
